...
class ControleurLancerMenu1(private var menu: MenuPerso1, private var primaryStage: Stage, private var grille : GrilleJeu, private var jeu: Jeu, private var nombreJoueurs: NombreJoueurs, private var main : MainVue): EventHandler<ActionEvent> {
    ...
    override fun handle(p0: ActionEvent?) {
        ...
        menu.boutton1.onAction = ControleurInit1J(jeu, menu, grille, primaryStage,main)
    }
}