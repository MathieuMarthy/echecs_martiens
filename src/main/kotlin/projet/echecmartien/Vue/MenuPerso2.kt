...
public class MenuPerso2: GridPane() {
    ...
    init {
        ...
        ligne4.valignment = VPos.CENTER
        ligne4.percentHeight = 20.0
        ...
        choix_de_couleur2.prefWidth = 300.0


        this.add(titre, 2, 0)
        this.add(pseudo1, 1, 1)
        this.add(pseudo2, 1, 1)
        ...
        this.add(choix_de_couleur2, 3, 3)
        this.add(boutton1, 2,4)
        this.add(boutton2, 3,4)
